...
def create_model(x_train, y_train, x_test, y_test, space, input_shape):
    ...
    with open('output.csv', 'a', newline='') as csvfile:
        ...
        writer.writerow([numoffilter, kernal_size, numofstrides, batch_size, activation, numoflayer, numofnode1, numofnode2, numofnode3, numofnode4, dropout, lr, epoch_times, stft_len, overlap, acc])
